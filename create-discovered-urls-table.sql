-- Create discovered_urls table for the Enhanced Data Pipeline
...
-- Insert a few test URLs to verify the table works
INSERT INTO public.discovered_urls (url, discovery_method, notes, metadata) VALUES
('https://example-food-truck-1.com', 'manual', 'Test URL for pipeline verification', '{"test": true, "priority": "high"}'),
('https://example-food-truck-2.com', 'manual', 'Test URL for pipeline verification', '{"test": true, "priority": "medium"}')
