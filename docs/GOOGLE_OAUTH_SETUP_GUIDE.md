...
3. Fill in required fields:
   ...
   - **User support email**: `zabrien@gmail.com`
   ...
   - **Developer contact**: `zabrien@gmail.com`
...
5. **Test users** (for development): Add `zabrien@gmail.com`
...
The current admin placeholder `admin@example.com` should be replaced with `zabrien@gmail.com`:

1. In Supabase Dashboard > Authentication > Users
2. Find the admin user
3. Update email to `zabrien@gmail.com`
4. Ensure role is set to `admin` in profiles table

### 5.2 Verify Role-Based Access
1. Test login with `zabrien@gmail.com`
...
- [ ] Admin user email updated to `zabrien@gmail.com`
