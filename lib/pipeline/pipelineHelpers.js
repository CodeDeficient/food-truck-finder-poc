...
export async function validateInputAndPrepare(jobId, extractedTruckData, sourceUrl) {
    ...
    // CRITICAL: If name is null, undefined, or empty, discard the truck data
    if (!extractedTruckData.name || extractedTruckData.name === null || extractedTruckData.name.trim() === '') {
