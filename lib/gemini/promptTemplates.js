...
name: string (food truck name. If a clear, real-world food truck name cannot be confidently extracted, return null for the entire truck object to indicate it should be discarded.)
  ...
  - category: string (menu category)
    items:
      - name: string (item name)
        ...
        dietary_tags:
          - string (dietary restrictions/tags)
specialties:
  - string (signature dishes or specialties)
dietary_options:
  - string (dietary accommodations like vegan, gluten-free)
...
- Be thorough in extracting menu items and their details
- Look for social media links and contact information carefully
- Return only the YAML object, no additional text or formatting
