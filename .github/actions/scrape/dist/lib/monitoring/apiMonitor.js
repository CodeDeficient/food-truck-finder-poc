 ...
 */
import { APIUsageService } from '../../lib/supabase/services/apiUsageService.js';
...
export class APIMonitor {
    static get alertHistory() {
        if (!this._alertHistory) {
            this._alertHistory = [];
        }
        return this._alertHistory;
    }
    
    static set alertHistory(value) {
        this._alertHistory = value;
    }
    /**
