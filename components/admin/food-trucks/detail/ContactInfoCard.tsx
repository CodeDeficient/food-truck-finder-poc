    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <ContactField
          ...
          href={(truck.contact_info && truck.contact_info.phone !== null && truck.contact_info.phone !== undefined && truck.contact_info.phone.length > 0) ? `tel:${truck.contact_info.phone}` : undefined}
        ...
        <ContactField
          ...
          href={(truck.contact_info && truck.contact_info.email !== null && truck.contact_info.email !== undefined && truck.contact_info.email.length > 0) ? `mailto:${truck.contact_info.email}` : undefined}
