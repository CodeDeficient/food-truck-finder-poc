...
export class RateLimiter {
    ...
    static getStats() {
        ...
        for (const [key, entry] of rateLimitStore.entries()) {
            ...
            stats.entriesByType[type] = ((_a = stats.entriesByType[type]) !== null && _a !== void 0 ? _a : 0) + 1;
            if (entry.blocked) {
...
export function getClientIdentifier(request) {
    ...
    const ip = (_d = (_c = (_b = (_a = forwarded === null || forwarded === void 0 ? void 0 : forwarded.split(',')[0]) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : realIp) !== null && _c !== void 0 ? _c : cfConnectingIp) !== null && _d !== void 0 ? _d : 'unknown';
    // Include user agent for more specific identification
    const userAgent = (_e = request.headers.get('user-agent')) !== null && _e !== void 0 ? _e : 'unknown';
