...
async function logAndRedirectDenied({ req, res, requestMetadata, user, profile, profileQueryError, }) {
    ...
    return logSecurityEventAndRedirect({
        ...
        logParams: {
            event_type: 'permission_denied',
            user_id: user.id,
            user_email: (_a = user.email) !== null && _a !== void 0 ? _a : undefined,
            ip_address: requestMetadata.ip,
            user_agent: requestMetadata.userAgent,
            details: {
                attempted_url: requestMetadata.url,
                user_role: (_b = profile === null || profile === void 0 ? void 0 : profile.role) !== null && _b !== void 0 ? _b : 'none',
                reason: 'insufficient_privileges',
                error: profileQueryError === null || profileQueryError === void 0 ? void 0 : profileQueryError.message,
            },
            severity: 'error',
        },
...
export async function protectAdminRoutes(req, res, requestMetadata) {
    ...
    if (userError || !user) {
        return logAndRedirect({
            ...
            requestMetadata,
            reason: 'no_session',
            userError: userError !== null && userError !== void 0 ? userError : undefined,
        });
    }
    ...
    if (profileQueryError || (profile && profile.role !== 'admin')) {
        return logAndRedirectDenied({
            ...
            profileQueryError: profileQueryError !== null && profileQueryError !== void 0 ? profileQueryError : undefined,
        });
    }
    if (req.method !== 'GET' || req.nextUrl.pathname.includes('/api/')) {
        await AuditLogger.logDataAccess({
            userId: user.id,
            userEmail: (_a = user.email) !== null && _a !== void 0 ? _a : 'unknown',
