...
function assessLocationData(truck, issues, currentScore) {
    var _a, _b;
    let score = currentScore;
    if (typeof ((_a = truck.current_location) === null || _a === void 0 ? void 0 : _a.lat) !== 'number' ||
        Number.isNaN(truck.current_location.lat) ||
        typeof ((_b = truck.current_location) === null || _b === void 0 ? void 0 : _b.lng) !== 'number' ||
...
export const DataQualityService = {
    ...
    async batchUpdateQualityScores(limit = 100) {
        ...
        const trucks = (_a = data) !== null && _a !== void 0 ? _a : [];
        ...
        return { updatedCount: count !== null && count !== void 0 ? count : 0, errors: [] };
    },
