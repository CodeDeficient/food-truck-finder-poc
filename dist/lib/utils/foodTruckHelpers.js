...
export const getPopularItems = (truck) => {
    ...
    return ((_b = (_a = truck.menu) === null || _a === void 0 ? void 0 : _a.flatMap((category) => category.items).filter((item) => Boolean(item && item.is_popular === true))) !== null && _b !== void 0 ? _b : []);
};
/**
...
export const getPriceRange = (truck) => {
    var _a;
    const allItems = (_a = truck.menu) === null || _a === void 0 ? void 0 : _a.flatMap((category) => category.items);
...
export const getTodayHours = (truck) => {
    ...
    return (_a = truck.operating_hours) === null || _a === void 0 ? void 0 : _a[today];
};
...
export function isTruckOpen(truck) {
    var _a;
    const today = getCurrentDay();
    const hours = (_a = truck.operating_hours) === null || _a === void 0 ? void 0 : _a[today];
