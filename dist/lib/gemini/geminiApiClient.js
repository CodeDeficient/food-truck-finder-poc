    ...
    */
    async makeRequest(prompt, config = {}) {
        ...
        try {
            const sdkResponse = await this.genAI.models.generateContent({
                ...
                config: { temperature: (_a = config.temperature) !== null && _a !== void 0 ? _a : 0 },
            });
            textOutput = (_b = sdkResponse.text) !== null && _b !== void 0 ? _b : '';
            const tokensUsed = (_d = (_c = sdkResponse.usageMetadata) === null || _c === void 0 ? void 0 : _c.totalTokenCount) !== null && _d !== void 0 ? _d : Math.ceil((prompt.length + textOutput.length) / 4);
    ...
    async makeRequestWithParsing(prompt, parser, config = {}) {
        ...
        try {
            ...
            console.warn('Problematic Gemini raw response text:', (_b = (_a = response.data) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : 'No data');
            return {
                success: false,
                error: `Failed to parse Gemini response: ${parseError instanceof Error ? parseError.message : String(parseError)}. Response text: ${(_d = (_c = response.data) === null || _c === void 0 ? void 0 : _c.trim().slice(0, 200)) !== null && _d !== void 0 ? _d : 'No data'}...`,
                tokensUsed: response.tokensUsed,
            };
        }
    }
