...
export const API_LIMITS = {
    gemini: {
        ...
        tokens: { daily: 32000, hourly: 2000 },
    ...
    supabase: {
        requests: { daily: 50000, hourly: 5000 },
        tokens: { daily: 0, hourly: 0 },
...
export class APIMonitor {
    ...
    static async canMakeRequest(service, requestCount = 1, tokenCount = 0) {
        ...
        try {
            ...
            const newTokenCount = ((_b = (_a = usage.tokens) === null || _a === void 0 ? void 0 : _a.used) !== null && _b !== void 0 ? _b : 0) + tokenCount;
    ...
    static async getCurrentUsage(service) {
        ...
        const usage = {
            requests: {
                used: (_a = todayUsage === null || todayUsage === void 0 ? void 0 : todayUsage.requests_count) !== null && _a !== void 0 ? _a : 0,
                limit: limits.requests.daily,
                percentage: (((_b = todayUsage === null || todayUsage === void 0 ? void 0 : todayUsage.requests_count) !== null && _b !== void 0 ? _b : 0) / limits.requests.daily) * 100,
            },
        };
        if (limits.tokens.daily > 0) {
            usage.tokens = {
                used: (_c = todayUsage === null || todayUsage === void 0 ? void 0 : todayUsage.tokens_used) !== null && _c !== void 0 ? _c : 0,
                limit: limits.tokens.daily,
                percentage: (((_d = todayUsage === null || todayUsage === void 0 ? void 0 : todayUsage.tokens_used) !== null && _d !== void 0 ? _d : 0) / limits.tokens.daily) * 100,
            };
        }
        return usage;
    }
    ...
    static generateRecommendations(usage, alerts) {
        ...
        if (((_b = (_a = usage.gemini) === null || _a === void 0 ? void 0 : _a.requests) === null || _b === void 0 ? void 0 : _b.percentage) > 70) {
            recommendations.push('Gemini: Optimize prompt length and complexity', 'Gemini: Implement response caching for similar queries');
        }
        if (((_d = (_c = usage.firecrawl) === null || _c === void 0 ? void 0 : _c.requests) === null || _d === void 0 ? void 0 : _d.percentage) > 70) {
