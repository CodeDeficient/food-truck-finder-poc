...
async function processFirecrawlStage(url, rawText, logs) {
    const firecrawlStageOutput = await handleFirecrawlStage(url !== null && url !== void 0 ? url : '', rawText, logs);
...
async function executeFirecrawlStage(url, rawText, logs) {
    const firecrawlStageOutput = await processFirecrawlStage(url !== null && url !== void 0 ? url : '', rawText, logs);
