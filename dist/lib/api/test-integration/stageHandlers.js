...
async function handleUrlScrape(url, logs) {
    ...
    try {
        ...
        if (fcOutput.success === true &&
            ((_a = fcOutput.data) === null || _a === void 0 ? void 0 : _a.markdown) !== undefined &&
            ((_b = fcOutput.data) === null || _b === void 0 ? void 0 : _b.markdown) !== '') {
            return {
                contentToProcess: fcOutput.data.markdown,
                sourceUrlForProcessing: (_c = fcOutput.data.source_url) !== null && _c !== void 0 ? _c : url,
                firecrawlResult: {
                    status: 'Success',
            ...
            throw new Error((_d = fcOutput.error) !== null && _d !== void 0 ? _d : 'Firecrawl failed to return markdown.');
        }
    }
    catch (error) {
...
export async function handleGeminiStage(contentToProcess, sourceUrlForProcessing, logs) {
    ...
    try {
        ...
        if (geminiOutput.success === true && geminiOutput.data !== undefined) {
            ...
            throw new Error((_a = geminiOutput.error) !== null && _a !== void 0 ? _a : 'Gemini processing failed to return data.');
        }
    }
    catch (error) {
