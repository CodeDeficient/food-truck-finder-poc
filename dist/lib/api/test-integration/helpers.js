...
export async function testSupabaseOperations(testUrl, geminiResult) {
    ...
    const testTruck = await createTestFoodTruck(testUrl, (_a = geminiResult.data) !== null && _a !== void 0 ? _a : []);
...
export function formatTestResults(scrapeResult, geminiResult, supabaseResults) {
    ...
    return {
        ...
        results: {
            firecrawl: {
                success: (_b = (_a = scrapeResult.result) === null || _a === void 0 ? void 0 : _a.success) !== null && _b !== void 0 ? _b : false,
                dataLength: (_f = (_e = (_d = (_c = scrapeResult.result) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.markdown) === null || _e === void 0 ? void 0 : _e.length) !== null && _f !== void 0 ? _f : 0,
            },
            gemini: {
                success: geminiResult.success,
                tokensUsed: geminiResult.tokensUsed,
                categoriesFound: (_h = (_g = geminiResult.data) === null || _g === void 0 ? void 0 : _g.length) !== null && _h !== void 0 ? _h : 0,
            },
            supabase: {
