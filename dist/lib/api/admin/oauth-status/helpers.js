...
export async function handleGetRequest(_request) {
    ...
    return NextResponse.json(Object.assign(Object.assign({ success: true }, status), { legacy_format: {
        ...
        if (typeof supabaseUrl === 'string' && supabaseUrl.length > 0) {
            ...
            if (settingsResponse.ok === true) {
                ...
                status.supabase.authSettings = {
                    googleEnabled: (_b = (_a = settings.external) === null || _a === void 0 ? void 0 : _a.google) !== null && _b !== void 0 ? _b : false,
                    signupEnabled: settings.disable_signup === false,
                    autoconfirm: (_c = settings.autoconfirm) !== null && _c !== void 0 ? _c : false,
                };
                if (((_d = settings.external) === null || _d === void 0 ? void 0 : _d.google) !== undefined) {
...
function generateRecommendations(status) {
    ...
    if (((_a = status.supabase.authSettings) === null || _a === void 0 ? void 0 : _a.googleEnabled) === true) {
...
function determineOverallStatus(status) {
    ...
    if (((_a = status.supabase.authSettings) === null || _a === void 0 ? void 0 : _a.googleEnabled) && status.oauth_flow.authProviderConfigured) {
        return 'ready';
    }
