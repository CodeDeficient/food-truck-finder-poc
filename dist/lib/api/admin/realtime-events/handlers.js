...
async function fetchRealtimeMetrics() {
    ...
    try {
        ...
        const dataQualityMetrics = {
            averageScore: (_a = qualityStats.avg_quality_score) !== null && _a !== void 0 ? _a : 0,
            totalTrucks: (_b = qualityStats.total_trucks) !== null && _b !== void 0 ? _b : 0,
            recentChanges: 0,
        };
        const systemHealth = {
            status: 'healthy',
