...
export async function handleFullCleanup(options) {
    ...
    const result = await BatchCleanupService.runFullCleanup({
        batchSize: (_a = options === null || options === void 0 ? void 0 : options.batchSize) !== null && _a !== void 0 ? _a : 50,
        dryRun: (_b = options === null || options === void 0 ? void 0 : options.dryRun) !== null && _b !== void 0 ? _b : false,
        operations: options === null || options === void 0 ? void 0 : options.operations,
    });
...
export async function handleCheckDuplicates(options) {
    const { truckData } = options !== null && options !== void 0 ? options : {};
    if (!truckData) {
...
export async function handleMergeDuplicates(options) {
    const { targetId, sourceId } = options !== null && options !== void 0 ? options : {};
...
export async function handleDryRun(options) {
    const result = await BatchCleanupService.runFullCleanup(Object.assign(Object.assign({}, options), { operations: options === null || options === void 0 ? void 0 : options.operations, dryRun: true }));
    return NextResponse.json({
        success: true,
        action: 'dry-run',
        result,
