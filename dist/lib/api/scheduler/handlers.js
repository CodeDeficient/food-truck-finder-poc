...
export function handleUpdateTask(body) {
    ...
    schedulerTasks[taskIndex] = Object.assign(Object.assign({}, schedulerTasks[taskIndex]), config);
    ...
    if (config.intervalMinutes != undefined &&
        ...
        const lastRun = new Date((_a = schedulerTasks[taskIndex].lastRun) !== null && _a !== void 0 ? _a : Date.now());
