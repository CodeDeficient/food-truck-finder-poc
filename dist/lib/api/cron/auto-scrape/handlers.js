...
function logAutoScrapeCompletion(result) {
    ...
    logActivity({
        ...
        details: {
            ...
            errorsCount: (_b = (_a = result.errors) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0,
        },
    });
...
export async function handlePostRequest(request) {
    ...
    try {
        ...
        const result = {
            ...
            errors: (_a = rawResult.errors) === null || _a === void 0 ? void 0 : _a.map((e) => e.url + (e.details ? `: ${e.details}` : '')),
        };
