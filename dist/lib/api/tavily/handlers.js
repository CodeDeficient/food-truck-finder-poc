...
async function callTavilySearchApi(apiKey, params) {
    ...
    const response = await fetch('https://api.tavily.com/search', {
        ...
        body: JSON.stringify({
            query: (_a = params.query) !== null && _a !== void 0 ? _a : params.q,
            max_results: (_b = params.limit) !== null && _b !== void 0 ? _b : 10,
            search_depth: (_c = params.search_depth) !== null && _c !== void 0 ? _c : 'advanced',
            include_answer: true,
    ...
    return {
        results: (_e = (_d = data.results) === null || _d === void 0 ? void 0 : _d.map((result) => ({
            title: result.title,
            url: result.url,
