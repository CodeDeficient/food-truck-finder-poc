...
export async function handleServiceSpecificMonitoring(request, service) {
    ...
    if (action === 'check') {
        const requestCount = Number.parseInt((_a = searchParams.get('requests')) !== null && _a !== void 0 ? _a : '1', 10);
        const tokenCount = Number.parseInt((_b = searchParams.get('tokens')) !== null && _b !== void 0 ? _b : '0', 10);
