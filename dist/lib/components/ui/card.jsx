...
const Card = React.forwardRef(({ className, ...props }, ref) => (<div ref={ref} className={cn('glass rounded-modern text-card-foreground shadow-lg hover:shadow-xl transition-all duration-300', className)} {...props}/>));
