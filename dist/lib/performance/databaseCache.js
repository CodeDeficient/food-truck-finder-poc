...
export const CachedFoodTruckService = {
    ...
    searchTrucksCached: unstable_cache(async (query, filters) => {
        ...
        // Apply filters
        if ((filters === null || filters === void 0 ? void 0 : filters.cuisine) != undefined && filters.cuisine !== '') {
            dbQuery = dbQuery.contains('cuisine_type', [filters.cuisine]);
        }
        const { data, error } = await dbQuery.limit(50);
        const trucks = data !== null && data !== void 0 ? data : [];
        if (error != undefined) {
            const errorMessage = error instanceof Error ? error.message : JSON.stringify(error);
            throw new Error(`Search query failed: ${errorMessage}`);
        }
        let results = trucks !== null && trucks !== void 0 ? trucks : [];
        // Apply location filter if provided
        if ((filters === null || filters === void 0 ? void 0 : filters.lat) != undefined && (filters === null || filters === void 0 ? void 0 : filters.lng) != undefined && (filters === null || filters === void 0 ? void 0 : filters.radius) != undefined) {
            results = results.filter((truck) => {
                var _a, _b, _c;
                if (((_a = truck.current_location) === null || _a === void 0 ? void 0 : _a.lat) == undefined ||
                    ((_b = truck.current_location) === null || _b === void 0 ? void 0 : _b.lng) == undefined) {
                    return false;
                }
                ...
                return distance <= ((_c = filters.radius) !== null && _c !== void 0 ? _c : 10);
            });
        }
        // Apply openNow filter if provided
        if ((filters === null || filters === void 0 ? void 0 : filters.openNow) === true) {
            const now = new Date();
            ...
            results = results.filter((truck) => {
                ...
                if (hours == undefined || hours.closed === true)
                    return false;
                const openTime = parseTimeString((_b = hours.open) !== null && _b !== void 0 ? _b : '');
                const closeTime = parseTimeString((_c = hours.close) !== null && _c !== void 0 ? _c : '');
    ...
    getDataQualityStatsCached: unstable_cache(async () => {
        ...
        const scores = trucks == undefined
            ? []
            : trucks.map((t) => { var _a; return (_a = t.data_quality_score) !== null && _a !== void 0 ? _a : 0; });
...
function parseTimeString(timeStr) {
    ...
    return hours * 100 + (minutes !== null && minutes !== void 0 ? minutes : 0);
}
