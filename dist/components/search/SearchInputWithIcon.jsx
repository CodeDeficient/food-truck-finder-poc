 ...
 */
export function SearchInputWithIcon({ value, onChange, onKeyDown, placeholder, }) {
    return (<div className="relative grow min-w-[200px]">
      <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500 size-4"/>
      <Input placeholder={placeholder} value={value} onChange={onChange} className="pl-10 w-full dark:bg-slate-700 dark:text-gray-100 dark:placeholder:text-gray-400" onKeyDown={onKeyDown}/>
    </div>);
}
