 ...
 */
export function SearchFilterContent({ onSearch, loading }) {
    const { filters, setFilters, showAdvanced, setShowAdvanced, handleSearch, clearFilters, activeFilterCount, cuisineTypes, } = useSearchFiltersLogic(onSearch);
    return (<div className="space-y-4">
      <MainSearchSection filters={filters} setFilters={setFilters} loading={loading} handleSearch={handleSearch} showAdvanced={showAdvanced} setShowAdvanced={setShowAdvanced} activeFilterCount={activeFilterCount}/>
      {showAdvanced && (<AdvancedFilters filters={filters} setFilters={setFilters} clearFilters={clearFilters} cuisineTypes={cuisineTypes}/>)}
    </div>);
}
