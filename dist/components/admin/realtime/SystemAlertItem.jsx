 ...
 */
const getAlertClasses = (type, acknowledged) => {
...
export function SystemAlertItem({ alert, onAcknowledgeAlert }) {
    return (<div className={`p-2 rounded border-l-4 ${getAlertClasses(alert.type, alert.acknowledged)}`}>
      <div className="flex items-center justify-between">
        ...
        {alert.acknowledged !== true && (<Button variant="ghost" size="sm" onClick={() => onAcknowledgeAlert(alert.id)}>
            Acknowledge
          </Button>)}
      </div>
