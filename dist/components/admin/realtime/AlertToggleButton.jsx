 ...
 */
export function AlertToggleButton({ alertsLength, showDetails, onToggleDetails, }) {
    if (alertsLength <= 3)
        return;
    return (<Button variant="outline" size="sm" className="mt-2" onClick={onToggleDetails} type="button">
