'use client';
import {} from '@/hooks/useSystemAlerts'; // Import SystemAlert type
 ...
 */
export function SystemAlerts({ alerts, showDetails, onToggleDetails, onAcknowledgeAlert, }) {
    if (alerts.length === 0)
        return;
    return (<div className="mt-4">
      <h4 className="text-sm font-medium text-gray-900 mb-2">Recent Alerts</h4>
      <AlertListDisplay alerts={alerts} showDetails={showDetails} onToggleDetails={onToggleDetails} onAcknowledgeAlert={onAcknowledgeAlert}/>
    </div>);
}
