...
export function DataCleanupDashboard() {
    const { isRunning, lastResult, previewData, selectedOperations, runCleanup, loadPreview, toggleOperation, } = useDataCleanup();
    return (<div className="space-y-6">
      <CleanupHeader isRunning={isRunning} onPreview={() => {
            void loadPreview();
        }} onDryRun={() => {
      ...
      <OperationSelector selectedOperations={selectedOperations} onToggleOperation={toggleOperation}/>
