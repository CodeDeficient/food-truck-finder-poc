...
export default function TruckCard({ title, price, reviews, image_url, rating }) {
    ...
    return (<div className="bg-white p-4 rounded-md">
      <Image src={image_url} alt={title} width={imageWidth} height={imageHeight} className="mb-3"/>
      <h3>{title}</h3>
