...
*/
export function ContactSection({ contactInfo, verificationStatus }) {
    return (<div>
      ...
      <div className="space-y-1 dark:text-gray-300">
        ...
        {verificationStatus !== undefined && (<div className="flex items-center text-xs text-gray-500 dark:text-gray-400">
