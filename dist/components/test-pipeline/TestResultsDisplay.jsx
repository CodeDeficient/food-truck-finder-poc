...
export function TestResultsDisplay({ results, renderStageResult, }) {
    if (!results || results.error !== undefined)
        return;
    return (<Card>
      <CardHeader>
        <CardTitle>Test Results</CardTitle>
        {results.overallStatus !== undefined && (<CardDescription>Overall Status: {results.overallStatus}</CardDescription>)}
      </CardHeader>
      <CardContent>
        ...
        {results.logs !== undefined && results.logs.length > 0 && (<div className="mt-4">
