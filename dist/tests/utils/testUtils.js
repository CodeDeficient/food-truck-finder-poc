...
export const TestUtils = {
     ...
     */
    async makeTestRequest(url, config) {
        try {
     ...
     */
    async insertTestFoodTruck(truckData) {
        try {
            if (!supabaseAdmin) {
                throw new Error('Supabase admin client not available');
            }
     ...
     */
    async waitForCondition(condition, timeoutMs = 10_000, intervalMs = 500) {
