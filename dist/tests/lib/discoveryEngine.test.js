...
describe('DiscoveryEngine', () => {
    ...
    describe('searchForFoodTrucks', () => {
        it('should search for food trucks in a city successfully', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('/api/tavily', expect.objectContaining({
                method: 'POST',
        ...
        it('should extract URLs from search results', async () => {
            ...
            jest.spyOn(discoveryEngine, 'extractUrlsFromText').mockReturnValue(extractedUrls);
    ...
    describe('crawlDirectory', () => {
        it('should crawl a directory URL successfully', async () => {
            ...
            expect(result.success).toBe(true);
            expect(mockFetch).toHaveBeenCalledWith('/api/firecrawl', expect.objectContaining({
                method: 'POST',
            }));
        });
    ...
    describe('runDiscovery', () => {
        it('should run complete discovery process', async () => {
            ...
            // Mock URL extraction
            jest
                .spyOn(discoveryEngine, 'extractUrlsFromText')
    ...
    describe('validateFoodTruckUrl', () => {
        it('should validate food truck URLs correctly', () => {
            ...
            for (const url of validUrls) {
                expect(discoveryEngine.validateFoodTruckUrl(url)).toBe(true);
            }
            for (const url of invalidUrls) {
                expect(discoveryEngine.validateFoodTruckUrl(url)).toBe(false);
            }
        });
    });
    describe('extractUrlsFromText', () => {
      ...
      `;
            const urls = discoveryEngine.extractUrlsFromText(text);
