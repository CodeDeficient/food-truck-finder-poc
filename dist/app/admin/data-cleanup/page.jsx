...
function FeatureOverviewCards() {
    return (<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <FeatureCard title="Duplicate Prevention" icon={<Merge className="size-4 text-purple-600"/>} value="85%+" description="Similarity detection with intelligent merging" colorClass="text-purple-600"/>
      <FeatureCard title="Automated Cleanup" icon={<RefreshCw className="size-4 text-blue-600"/>} value="5 Types" description="Placeholder removal, phone normalization, coordinate fixes" colorClass="text-blue-600"/>
      <FeatureCard title="Quality Scoring" icon={<Zap className="size-4 text-green-600"/>} value="Real-time" description="Automatic quality score recalculation" colorClass="text-green-600"/>
      <FeatureCard title="Batch Processing" icon={<Shield className="size-4 text-yellow-600"/>} value="Safe" description="Dry run mode with comprehensive error handling" colorClass="text-yellow-600"/>
    </div>);
}
