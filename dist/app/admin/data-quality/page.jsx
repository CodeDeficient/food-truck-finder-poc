...
import { formatQualityScore, categorizeQualityScore, getQualityBadgeClasses, getQualityScoreAriaLabel, } from '@/lib/utils/QualityScorer';
 ...
 */
function FoodTruckQualityTable({ trucks }) {
    return (<Card>
      <CardHeader>
      ...
      <CardContent>
        <Table>
          ...
          <TableBody>
            {trucks.map((truck) => (<FoodTruckQualityRow key={truck.id} truck={truck}/>))}
          </TableBody>
        </Table>
      </CardContent>
    </Card>);
